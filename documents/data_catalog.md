...
| <div align="center">Column Name</div> | <div align="center">Data Type</div> | <div align="center">Description</div> |
| :--- | :--- | :--- |
...
| birthdate | DATE | The date of birth of the customer, formatted as YYYY-MM-DD (e.g., 1999-10-17). |
...
| sales_amount | DECIMAL(18, 2) | The total monetary value of the sale for the line item (e.g., 26.99). |
| quantity | INT | The number of units of the product ordered for the line item. |
| price | DECIMAL(18, 2) | The unit price of the product for the line item (e.g., 26.99). |
